...
histogram_blue = cv2.calcHist([imgclr],[0],None,[256],[0,256])
plt.plot(histogram_blue, color='blue') 
histogram_green = cv2.calcHist([imgclr],[1],None,[256],[0,256]) 
plt.plot(histogram_green, color='green') 
histogram_red = cv2.calcHist([imgclr],[2],None,[256],[0,256]) 
